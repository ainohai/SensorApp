...
val keystorePropertiesFile = rootProject.file("polarapp.properties")
val polarAppisProperties = Properties()
polarAppisProperties.load(FileInputStream(keystorePropertiesFile))
...
android {
    ...
    defaultConfig {
        ...
        testInstrumentationRunner = "fi.ainon.polarAppis.HiltTestRunner"
        vectorDrawables {
